...
import os
import sys
sys.path.append('/NNHiremaster/NNA')
from . import NearestNeightbourModular as NNM
from . import GPTDynamicWebpage as GDW
...
def generate_random_data_point(min_max_values):
    ...
    return GDW.CreateWebpageFromPoint(random_data_point)
